  ...
  return (
    <div className="container">
      ...
      <main className="main">
        ...
        <div className="cta">
          <Link href="/notes">
            <button className="view-notes-btn">View All Notes →</button>
          </Link>
      ...
      <style jsx>{`
        ...
        .header button { background: white; color: #667eea; border: none; padding: 0.75rem 2rem; border-radius: 10px; font-size: 1rem; font-weight: 600; cursor: pointer; transition: all 0.3s; }
        .header button:hover { transform: translateY(-2px); box-shadow: 0 5px 15px rgba(255, 255, 255, 0.3); }
        ...
        .feature-card { background: rgba(255, 255, 255, 0.95); padding: 2rem; border-radius: 20px; text-align: center; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.2); transition: transform 0.3s; }
        .feature-card:hover { transform: translateY(-5px); }
        .feature-card h3 { color: #667eea; font-size: 1.5rem; margin-bottom: 1rem; }
        .feature-card p { color: #666; }
        .cta { text-align: center; margin-top: 3rem; }
        .view-notes-btn { background: white; color: #667eea; border: none; padding: 1.25rem 3rem; border-radius: 15px; font-size: 1.3rem; font-weight: 700; cursor: pointer; transition: all 0.3s; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.2); }
        .view-notes-btn:hover { transform: scale(1.05); box-shadow: 0 15px 40px rgba(0, 0, 0, 0.3); }
        .info-text { color: white; margin-top: 1.5rem; font-size: 1.1rem; opacity: 0.9; }
        @media (max-width: 768px) { h1 { font-size: 2rem; } .hero h2 { font-size: 1.8rem; } .features { grid-template-columns: 1fr; } }
      `}</style>
    </div>
  )
}
